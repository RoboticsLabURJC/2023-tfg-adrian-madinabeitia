...
def generate_launch_description():
  ...
  neuralDriver = Node(
      package='drone_driver',
      executable='carNeuralPilot.py',
      output='screen'
    )  
  
  bagRecorder = ExecuteProcess(
      cmd=['ros2', 'bag', 'record',  '/cmd_vel', '/cam_f1_left/image_raw', '-o', 'datasetBag'],
    )
  ...
  #ld.add_action(expertDriver)
  #ld.add_action(bagRecorder)

  # ld.add_action(filterImage)
  #ld.add_action(neuralDriver) 
  return ld